...
extension Analytics {
    ...
    public func with(_ parameters: [String: CustomStringConvertible]) -> Self {
        var copy = self
    ...
    @_disfavoredOverload
    public func with(_ key: String, _ value: CustomStringConvertible) -> Self {
        with([key: value])
    }
    ...
    /// - Returns: A new instance of `Analytics` with the updated parameter.
    public func with<T: RawRepresentable>(_ key: String, _ value: T) -> Self where T.RawValue: CustomStringConvertible {
